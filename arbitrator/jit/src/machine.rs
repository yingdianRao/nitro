...
pub fn create(opts: &Opts, env: WasmEnv) -> (Instance, FunctionEnv<WasmEnv>, Store) {
    ...
    let imports = imports! {
        "go" => {
            ...
            "github.com/yingdianRao/nitro/wavmio.getGlobalStateBytes32" => func!(wavmio::get_global_state_bytes32),
            "github.com/yingdianRao/nitro/wavmio.setGlobalStateBytes32" => func!(wavmio::set_global_state_bytes32),
            "github.com/yingdianRao/nitro/wavmio.getGlobalStateU64" => func!(wavmio::get_global_state_u64),
            "github.com/yingdianRao/nitro/wavmio.setGlobalStateU64" => func!(wavmio::set_global_state_u64),
            "github.com/yingdianRao/nitro/wavmio.readInboxMessage" => func!(wavmio::read_inbox_message),
            "github.com/yingdianRao/nitro/wavmio.readDelayedInboxMessage" => func!(wavmio::read_delayed_inbox_message),
            "github.com/yingdianRao/nitro/wavmio.resolvePreImage" => {
            ...
            "github.com/yingdianRao/nitro/wavmio.resolveTypedPreimage" => func!(wavmio::resolve_typed_preimage),

            "github.com/yingdianRao/nitro/arbcompress.brotliCompress" => func!(arbcompress::brotli_compress),
            "github.com/yingdianRao/nitro/arbcompress.brotliDecompress" => func!(arbcompress::brotli_decompress),
        },
    };
